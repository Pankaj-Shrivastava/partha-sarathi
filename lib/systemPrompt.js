...
export function getFormatInstruction(language = 'en') {
  const languageInstruction = language === 'hi' 
    ? `\n\nCRITICAL INSTRUCTION: You MUST write the "translation", "application", and "reflection" fields completely in Hindi. Do NOT use English for these fields.`
    : ``;
...
{
  "shloka": {
    "devanagari": "Translate the Romanized Sanskrit text into standard Unicode Devanagari script.",
...
Do not deviate from this JSON structure. All fields are required.${languageInstruction}`;
}
