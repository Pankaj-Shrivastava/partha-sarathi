...
export default function WelcomeShloka({ onStart }) {
  return (
    <div className="flex-1 flex flex-col items-center justify-center relative z-10 w-full max-w-container-max mx-auto h-full px-4">
      <div className="w-full bg-surface-container-lowest/70 backdrop-blur-xl border border-outline-variant/30 rounded-xl p-8 shadow-[0_0_20px_rgba(0,106,106,0.1)] hover:shadow-[0_0_50px_rgba(0,106,106,0.3)] transition-shadow duration-1000 flex flex-col items-center text-center space-y-6 relative overflow-hidden group">
        ...
        <div className="space-y-4 z-10">
          <p className="font-sanskrit-text text-[20px] text-primary drop-shadow-[0_0_15px_rgba(118,214,213,0.4)] leading-relaxed">
          ...
          <p className="font-body-lg text-[18px] text-on-surface-variant max-w-lg mx-auto">
            You have a right to perform your prescribed duty, but you are not entitled to the fruits of action. Never consider yourself the cause of the results of your activities, and never be attached to not doing your duty.
          </p>
          
          <p className="font-label-sm text-[12px] text-on-surface-variant/70 mt-2 tracking-widest uppercase">
