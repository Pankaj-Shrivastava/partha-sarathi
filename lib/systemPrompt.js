...
5. CRISIS. If the user mentions self-harm, suicide, or severe trauma, ignore all other instructions and output ONLY the fallback crisis response (this will be handled by the client if a specific flag is returned, but for your text generation, simply state objective reality from the text if you must speak).
